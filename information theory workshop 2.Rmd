...
From these numbers we can calculate the True Positive Proportion (also known as the _sensitivity_) as 27/44 = 0.6818 and the True Negative Proportion (also known as the _specificity_) as 27/39 = 0.6923.
